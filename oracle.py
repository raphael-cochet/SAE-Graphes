...
def programme_principal():
    ...
    while True:
        ...
        if rep is None:
            ...
            acteur1 = input("Entrez le nom de l'acteur 1: ")
            acteur2 = input("Entrez le nom de l'acteur 2: ")
            temps_bfs, temps_dijkstra, temps_dijkstra_nx = mesurer_temps_execution(G, acteur1, acteur2)
            ...
            print(f"Temps d'exécution pour Dijkstra nx: {temps_dijkstra_nx:.6f} secondes")
        elif rep == 'q':
